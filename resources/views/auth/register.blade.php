...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h2>S'inscrire</h2></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Prénom et nom</label>

                            <div class="col-md-6">
                                <input id="name" 
                                 placeholder="ex: Marie Duchêne"
                                 type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" 
                                 placeholder="ex: marie.duchene@gmail.com"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input 
                                    placeholder="mot de passe avec 8 charactères"
